(function () {
  ...
  // ✅ This function is fully contained inside the IIFE
  async function handleSendMessage() {
    ...
    // Add "thinking" element — we'll replace this later
...
`;
      ...
      while (true) {
        ...
        for (const line of lines) {
          ...
          if (parsed.response !== undefined) {
            ...
            // ✅ FIRST TOKEN: replace "thinking" with real message
            if (!assistantMsgDiv) {
      ...
      // If thinking is still present, remove it
      if (thinkingEl.parentNode === chatMessages) {
